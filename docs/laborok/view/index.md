...
Ezen a laboralkalmon belevágunk egy költségkezelő alkalmazás fejlesztésébe. A labor során a következő koncepciókkal ismerkedünk meg:
...
*   Poénból tegyünk bele egy névjegy menüt is, így ha más emberek is elkezdik használni az appot, akkor tudni fogják, hogy mi készítettük.
...
**Harmadik lépés:** Cseréljük le a `ViewCompat`-on történő függvényhíváshoz tartozó összes sort a `binding` objektum inicializálásával, illetve írjuk át a *setContentView* hívás paraméterét is (az *enableEdgeToEdge()* hívást is kiszedhetjük):
...
Emellett vegyünk fel egy tagváltozót, amelyben a növelendő összeg értékét tároljuk és egyet, amiben a kiadások listáját:
