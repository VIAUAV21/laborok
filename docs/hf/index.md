...
-	Legalább 5 technológia használata (pl. UI, egyedi nézetek, Fragmentek, RecyclerView, perzisztencia, hálózat, pozíciómeghatározás, animáció, Navigation Components, stílusok/témák, Service, BroadcastReceiver, Content Provider, Intent, stb.)
...
A házi feladatot a specifikáción túl dokumentálni kell készíteni a README.md fájlba. (A specifikáció után.) Ebben röviden ismertetni kell az elkészült alkalmazás funkcionalitását és az érdekesebb megoldásokat.