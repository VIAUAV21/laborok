# Labor02 - Fragmentek, Navigáció, ViewModel

Előző laboron eljutottunk odáig, hogy van egy képernyőnk, ahol látjuk a kiadásainkat és azok összegét, és egy másikon pedig hozzá tudjuk adni magát a kiadást. Emellett még egy névjegy dialógusunk is elkészült. Ez kezdetnek nem is rossz, de ha ránézünk a kódra, nem igazán az az érzésünk, hogy nagyon stabil architekturális alapokat fektettünk le. Valójában `Activity`-k között `Intent`-ekkel navigálunk és küldözgetjük az adatokat, mondhatni elég összetákolt módon. Márpedig ahhoz, hogy tovább bővíthessük az alkalmazásunkat egyéb funkciókkal, ennél profibb struktúrára lenne szükségünk.

**Mik az elvárásaink?**

*   Jó lenne, ha az egyes képernyőket és a köztük való navigációt egy gráf formájában láthatnánk magunk előtt. Így magabiztosan adhatnánk hozzá új képernyőket az apphoz.
*   Jó lenne, ha lenne valami biztosabb módszer arra, hogy adatokat adjunk át az egyes képernyők között, nem pedig `Intent`-ekbe kellene csomagolni és kiolvasni őket.
*   Az sem ártana, ha az adatokat, amiket a felhasználó visz be, egy központi helyen számon tudnánk tartani és bárhonnan könnyedén elérni.

A mai laboron ezekre az igényekre fogunk megoldásokat találni.
